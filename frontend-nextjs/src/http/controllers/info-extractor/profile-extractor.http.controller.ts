...
import { IProfileExtractorUseCase } from "@/core/application/usecases/info-extractor/profile-extractor.usecase";

export class ProfileExtractorController implements IController {
  constructor(
    private readonly logger: ILogger,
    private readonly profileExtractorUseCase: IProfileExtractorUseCase,
  ...
  async handle(
    ...
    try {
      ...
      const useCase = await this.profileExtractorUseCase.execute(body);
