...
import { TUpdateDbConnectionUseCase } from "@/core/application/usecases/dbconnection/update-dbconnection.usecase";

export class UpdateDbConnectionController implements IController {
  constructor(
    private readonly logger: ILogger,
    private readonly updateDbConnectionUseCase: TUpdateDbConnectionUseCase,
