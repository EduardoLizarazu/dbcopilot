...
import { ToggleNlqQaIgnoreComposer } from "@/infrastructure/services/composers/nlq/toggle-nlq-qa-ignore-composer.infra.service";
import { NextRequest } from "next/server";

export async function POST(req: NextRequest) {
  console.log("API: NLQ request...", req);
  const adapter = await nextAdapter(req, ToggleNlqQaIgnoreComposer(), {
