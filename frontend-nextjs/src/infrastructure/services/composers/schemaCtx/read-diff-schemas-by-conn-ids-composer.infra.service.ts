...
import { ReadDiffSchemaCtxController } from "@/http/controllers/schemaCtx/read-diff-schemas-by-conn-ids.http.controller";
...
export function ReadDiffSchemasByConnIdsComposer(): IController {
  ...
  // CONTROLLER
  const controller = new ReadDiffSchemaCtxController(
    loggerProvider,
    useCase,
    decodeTokenAdapter,
    authRepository
