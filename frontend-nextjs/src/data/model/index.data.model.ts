// ROLE DATA MODEL
export type { CreateRoleDataModel } from "@data/model/role/createRole.data.model";
export type { GetRolesDataModel } from "@data/model/role/getRoles.data.model";
export type { EditRoleDataModel } from "@data/model/role/editRole.data.model";
export type { GetRolesForUserDataModel } from "@data/model/role/getRolesForUser.data.model";

// PERMISSION DATA MODEL
export type { GetPermissionDataModel } from "@data/model/permission/getPermission.data.model";
export type { CreatePermissionDataModel } from "@data/model/permission/createPermission.data.model";
export type { UpdatePermissionDataModel } from "@data/model/permission/updatePermission.data.model";
